...
- [1. What is Integration?](#1-what-is-integration)
  - [Why is integration required?](#why-is-integration-required)
  - [Example](#example)
- [2. What is SAP Integration Suite?](#2-what-is-sap-integration-suite)
- [3. What is SAP CPI?](#3-what-is-sap-cpi)
- [4. What is an Integration Flow?](#4-what-is-an-integration-flow)
- [5. What Should an Integration Flow Design Answer?](#5-what-should-an-integration-flow-design-answer)
  - [WHAT?](#what)
  - [WHY?](#why)
  - [WHO?](#who)
  - [WHEN?](#when)
...
- [7. Point-to-Point vs Middleware Integration](#7-point-to-point-vs-middleware-integration)
  - [Point-to-Point](#point-to-point)
  - [Middleware](#middleware)
- [8. Integration Patterns](#8-integration-patterns)
  - [8.1 Request-Reply](#81-request-reply)
  - [9. One-Way / Fire-and-Forget](#9-one-way--fire-and-forget)
- [10. Synchronous Integration](#10-synchronous-integration)
- [11. Asynchronous Integration](#11-asynchronous-integration)
- [12. Content-Based Routing](#12-content-based-routing)
- [13. Message Transformation](#13-message-transformation)
  - [Source](#source)
  - [Target](#target)
- [14. Message Mapping](#14-message-mapping)
- [15. Content Modifier](#15-content-modifier)
  - [Message Body](#message-body)
  - [Headers](#headers)
  - [Properties](#properties)
- [16. Headers vs Properties](#16-headers-vs-properties)
  - [Header](#header)
  - [Property](#property)
- [17. Exchange / Message Concept](#17-exchange--message-concept)
- [18. Adapters](#18-adapters)
- [19. Sender vs Receiver Adapter](#19-sender-vs-receiver-adapter)
  - [Sender](#sender)
  - [Receiver](#receiver)
- [20. Protocol Conversion](#20-protocol-conversion)
- [21. Data Format Conversion](#21-data-format-conversion)
- [22. XML Fundamentals](#22-xml-fundamentals)
- [23. JSON Fundamentals](#23-json-fundamentals)
- [24. Routing](#24-routing)
- [25. Multicast](#25-multicast)
  - [Sequential](#sequential)
  - [Parallel](#parallel)
- [27. Splitter](#27-splitter)
- [28. Gather](#28-gather)
- [29. Enricher](#29-enricher)
- [30. Lookup](#30-lookup)
- [31. Validation](#31-validation)
- [32. Filtering](#32-filtering)
- [33. Duplicate Handling](#33-duplicate-handling)
- [34. Idempotency](#34-idempotency)
- [35. Exception Handling](#35-exception-handling)
- [36. Exception Subprocess](#36-exception-subprocess)
- [37. Retry Strategy](#37-retry-strategy)
- [38. Logging](#38-logging)
- [39. Correlation ID](#39-correlation-id)
- [40. Security](#40-security)
  - [Authentication](#authentication)
  - [Encryption](#encryption)
  - [Credentials](#credentials)
- [41. Certificates](#41-certificates)
- [42. Cloud Connector](#42-cloud-connector)
- [43. Externalized Parameters](#43-externalized-parameters)
- [44. Development Lifecycle](#44-development-lifecycle)
- [45. Naming Conventions](#45-naming-conventions)
- [46. Reusability](#46-reusability)
- [47. Groovy in CPI](#47-groovy-in-cpi)
- [48. When NOT to Use Groovy](#48-when-not-to-use-groovy)
- [49. XSLT](#49-xslt)
- [50. API-Based Integration](#50-api-based-integration)
- [51. HTTP Methods](#51-http-methods)
- [52. HTTP Status Codes](#52-http-status-codes)
- [53. Pagination](#53-pagination)
- [54. Batch Processing](#54-batch-processing)
- [55. Performance Design](#55-performance-design)
  - [Payload size](#payload-size)
  - [Groovy](#groovy)
  - [Logging](#logging-1)
  - [API calls](#api-calls)
- [56. Timeout Design](#56-timeout-design)
- [57. Transaction Design](#57-transaction-design)
- [58. Synchronous Error Response](#58-synchronous-error-response)
- [59. Asynchronous Error Handling](#59-asynchronous-error-handling)
- [60. Monitoring](#60-monitoring)
- [61. Monitoring Mindset](#61-monitoring-mindset)
- [62. Dead-Letter / Failed Message Strategy](#62-dead-letter--failed-message-strategy)
- [63. Error Classification](#63-error-classification)
